...
-- Sample donors
INSERT INTO donors (name, email, password, phone, address, blood_type, age, weight) VALUES
('John Doe', 'john@example.com', 'donor123', '555-0301', '123 Oak St', 'A+', 25, 70.5),
('Jane Smith', 'jane@example.com', 'donor123', '555-0302', '456 Elm Ave', 'O-', 30, 65.0),
('Mike Johnson', 'mike@example.com', 'donor123', '555-0303', '789 Pine Rd', 'B+', 28, 75.0);
